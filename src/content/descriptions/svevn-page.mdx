...
- Developed a WASM-based in-browser encryption and decryption mechanism for financial data using [_age_](https://github.com/FiloSottile/age) encryption library, supporting nested ZIP/encrypted file tree visualization and detailed CSV parsing error logging.
