export const badgesLinks = {
  Python:
    "https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=fff&style=flat-square",
  Flask:
    "https://img.shields.io/badge/Flask-000?logo=flask&logoColor=fff&style=flat-square",
  Jupyter:
    "https://img.shields.io/badge/Jupyter-F37626?logo=jupyter&logoColor=fff&style=flat-square",
  pandas:
    "https://img.shields.io/badge/pandas-150458?logo=pandas&logoColor=fff&style=flat-square",
  NumPy:
    "https://img.shields.io/badge/NumPy-013243?logo=numpy&logoColor=fff&style=flat-square",
  Pytest:
    "https://img.shields.io/badge/Pytest-0A9EDC?logo=pytest&logoColor=fff&style=flat-square",
  Plotly:
    "https://img.shields.io/badge/Plotly-3F4F75?logo=plotly&logoColor=fff&style=flat-square",
  Dash: "https://img.shields.io/badge/Dash-008DE4?logo=dash&logoColor=fff&style=flat-square",
  "scikit-learn":
    "https://img.shields.io/badge/scikit--learn-F7931E?logo=scikitlearn&logoColor=fff&style=flat-square",
  NLTK: null,
  Matplotlib: null,
  Transformers: null,
  PyTorch:
    "https://img.shields.io/badge/PyTorch-EE4C2C?logo=pytorch&logoColor=fff&style=flat-square",
  PRAW: null,
  NetworkX: null,
  Seaborn: null,
  SciPy:
    "https://img.shields.io/badge/SciPy-8CAAE6?logo=scipy&logoColor=fff&style=flat-square",
  JavaScript:
  ...
  Svelte:
    "https://img.shields.io/badge/Svelte-FF3E00?logo=svelte&logoColor=fff&style=flat-square",
  Astro:
    "https://img.shields.io/badge/Astro-BC52EE?logo=astro&logoColor=fff&style=flat-square",
  Angular:
    "https://img.shields.io/badge/Angular-0F0F11?logo=angular&logoColor=fff&style=flat-square",
  "Node.js":
    "https://img.shields.io/badge/Node.js-5FA04E?logo=nodedotjs&logoColor=fff&style=flat-square",
  Express:
    "https://img.shields.io/badge/Express-000?logo=express&logoColor=fff&style=flat-square",
  MongoDB:
    "https://img.shields.io/badge/MongoDB-47A248?logo=mongodb&logoColor=fff&style=flat-square",
  Firestore:
    "https://img.shields.io/badge/Firestore-DD2C00?logo=firebase&logoColor=fff&style=flat-square",
  Vercel:
    "https://img.shields.io/badge/Vercel-000?logo=vercel&logoColor=fff&style=flat-square",
  Heroku:
    "https://img.shields.io/badge/Heroku-430098?logo=heroku&logoColor=fff&style=flat-square",
  Docker:
  ...
  Cypress:
    "https://img.shields.io/badge/Cypress-69D3A7?logo=cypress&logoColor=fff&style=flat-square",
  Vitest:
    "https://img.shields.io/badge/Vitest-6E9F18?logo=vitest&logoColor=fff&style=flat-square",
  "Tailwind CSS":
    "https://img.shields.io/badge/Tailwind%20CSS-06B6D4?logo=tailwindcss&logoColor=fff&style=flat-square",
  Emotion: null,
  shadcn:
    "https://img.shields.io/badge/shadcn%2Fui-000?logo=shadcnui&logoColor=fff&style=flat-square",
  MUI: "https://img.shields.io/badge/MUI-007FFF?logo=mui&logoColor=fff&style=flat-square",
  RxJS: null,
  "D3.js":
    "https://img.shields.io/badge/D3.js-F9A03C?logo=d3dotjs&logoColor=fff&style=flat-square",
  "AG Grid": null,
  OpenStreetMap: null,
  Leaflet:
  ...
  OpenGL:
    "https://img.shields.io/badge/OpenGL-5586A4?logo=opengl&logoColor=fff&style=flat-square",
  Allegro: null,
  Ncurses: null,
  Java: null,
  Robocode: null,
